...
ConfigPage {
	...
	property string cfg_clickCommandID2
	...
	ExclusiveGroup { id: clickCommandGroupID2 }
	...
	ConfigSection {
		label: i18n("Targeted First Panel")
	...
	ConfigSection {
		label: i18n("Targeted Second Panel")

		RadioButton {
			text: i18nd("kwin_effects", "Hide/Unhide Panel ID 0")
			checked: cfg_clickCommandID2 == 'PanelID0'
			exclusiveGroup: clickCommandGroupID2
			onClicked: cfg_clickCommandID2 = 'PanelID0'
		}
		RadioButton {
			text: i18nd("kwin_effects", "Hide/Unhide Panel ID 1")
			checked: cfg_clickCommandID2 == 'PanelID1'
			exclusiveGroup: clickCommandGroupID2
			onClicked: cfg_clickCommandID2 = 'PanelID1'
		}
		RadioButton {
			text: i18nd("kwin_effects", "Hide/Unhide Panel ID 2")
			checked: cfg_clickCommandID2 == 'PanelID2'
			exclusiveGroup: clickCommandGroupID2
			onClicked: cfg_clickCommandID2 = 'PanelID2'
		}
		RadioButton {
			text: i18nd("kwin_effects", "Hide/Unhide Panel ID 3")
			checked: cfg_clickCommandID2 == 'PanelID3'
			exclusiveGroup: clickCommandGroupID2
			onClicked: cfg_clickCommandID2 = 'PanelID3'
		}
		RadioButton {
			text: i18nd("kwin_effects", "Hide/Unhide Panel ID 4")
			checked: cfg_clickCommandID2 == 'PanelID4'
			exclusiveGroup: clickCommandGroupID2
			onClicked: cfg_clickCommandID2 = 'PanelID4'
		}
		RadioButton {
			text: i18nd("kwin_effects", "Hide/Unhide Panel ID 5")
			checked: cfg_clickCommandID2 == 'PanelID5'
			exclusiveGroup: clickCommandGroupID2
			onClicked: cfg_clickCommandID2 = 'PanelID5'
		}
		RadioButton {
			text: i18nd("kwin_effects", "Hide/Unhide Panel ID 6")
			checked: cfg_clickCommandID2 == 'PanelID6'
			exclusiveGroup: clickCommandGroupID2
			onClicked: cfg_clickCommandID2 = 'PanelID6'
		}
	...
	ConfigSection {
		label: i18n("Working Mode - Switch/Toggle")
